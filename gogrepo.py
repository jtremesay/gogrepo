...
try:
    ...
    from urllib2 import HTTPCookieProcessor, HTTPError, Request, URLError, build_opener
...
def load_manifest(filepath=MANIFEST_FILENAME):
    ...
    try:
        with open(MANIFEST_FILENAME) as r:
...
def process_argv(argv):
    ...
    g1.add_argument(
        "-id",
        action="store",
        help="id of a specific game togogrepo.py update -os windows linux mac -lang en de frrform size check",
    )
    g1.add_argument(
